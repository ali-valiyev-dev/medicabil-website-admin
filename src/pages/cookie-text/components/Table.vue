...
import { useCookieTextStore } from 'src/stores/dialogs/cookieTextStore'
import { storeToRefs } from 'pinia'
import { EditDialog, DeleteDialog } from '../components'

const { form } = storeToRefs(useFilterStore())
const { nextOrder, showEditDialog, showDeleteDialog } = storeToRefs(useCookieTextStore())
...
const filteredRows = computed(() => {
  const { title, statusFilter, date } = form.value

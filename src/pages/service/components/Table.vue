...
import { useServiceStore } from 'src/stores/dialogs/serviceStore'
import { storeToRefs } from 'pinia'
import { EditDialog, DeleteDialog } from '../components'

const { form } = storeToRefs(useFilterStore())
const { nextOrder, showEditDialog, showDeleteDialog } = storeToRefs(useServiceStore())
...
const columns = ref([
  ...
  { name: 'branch', label: 'Hastane', align: 'left', field: 'branch' },

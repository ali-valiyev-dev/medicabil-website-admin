      ...
      <q-card-section>
        ...
        <q-form class="column">
          ...
          <div class="row no-wrap">
            ...
            <q-input v-model="form.buttonTitle" label="Buton Başlığı" outlined class="col" />
          </div>
          ...
          <div class="row no-wrap">
            ...
            <div class="row no-wrap q-gutter-md">
              ...
              <q-toggle
                v-model="form.isWhatsAppEnabled"
                label="WhatsApp"
                color="secondary"
                checked-icon="check"
                unchecked-icon="close"
              ...
              <q-toggle
                v-model="form.isContactFormEnabled"
...
<script setup>
import { ref } from 'vue'
import { useBlogStore } from 'src/stores/dialogs/blogStore'
import { storeToRefs } from 'pinia'

const DEFAULT_TARGET_LINK = 'https://dev.medicabil.com/tr/mukemmeliyet-merkezi/'

const { nextOrder, showAddDialog } = storeToRefs(useBlogStore())

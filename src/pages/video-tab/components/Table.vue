...
const { nextOrder, showEditDialog, showDeleteDialog } = storeToRefs(useVideoTabStore())
...
const columns = ref([
  ...
  { name: 'buttonTitle', label: 'Buton Başlığı', align: 'left', field: 'buttonTitle' },
  { name: 'videoUrl', label: ' Video Linki', align: 'left', field: 'videoUrl' },

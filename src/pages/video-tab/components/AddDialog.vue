    ...
    <q-card style="width: 100%; max-width: 1150px">
      <q-card-section>
        ...
        <q-form class="column">
          ...
          <div class="row no-wrap">
            <q-input v-model="form.videoLink" label="Video Linki" outlined class="col q-mr-md" />
...
<script setup>
import { ref } from 'vue'
import { useVideoTabStore } from 'src/stores/dialogs/videoTabStore'
import { storeToRefs } from 'pinia'

const { nextOrder, showAddDialog } = storeToRefs(useVideoTabStore())

<template>
  <q-form class="row justify-end q-mt-lg">
    <q-input v-model="form.description" clearable label="Açıklama" outlined class="col-3 q-mr-md" />
    ...
    <q-input
      ...
      label="Tarih Aralığı"
      class="date-input col-3 q-mr-md q-px-md rounded-borders"
    >
      <template #prepend>

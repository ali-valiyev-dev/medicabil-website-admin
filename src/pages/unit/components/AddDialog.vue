...
<script setup>
import { ref } from 'vue'
import { useUnitStore } from 'src/stores/dialogs/unitStore'
import { storeToRefs } from 'pinia'

const DEFAULT_TARGET_LINK = 'https://dev.medicabil.com/tr/unite/'

const { nextOrder, showAddDialog } = storeToRefs(useUnitStore())

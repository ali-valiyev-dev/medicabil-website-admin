...
const { showEditDialog, showDeleteDialog } = storeToRefs(useUserStore())
...
const columns = ref([
  ...
  { name: 'name', label: 'Ad', align: 'left', field: 'name' },
  { name: 'email', label: 'E-Posta', align: 'left', field: 'email' },
  { name: 'authority', label: 'Yetki', align: 'center', field: 'authority' },

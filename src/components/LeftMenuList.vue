...
const menuItems = ref([
  ...
  },
  {
    ...
    children: [
      ...
      { to: '/prefix', label: 'Ünvan' },
      { to: '/hospital', label: 'Hastaneler' },
      { to: '/magazine', label: 'Dergi' },
      { to: '/video-tab', label: 'Video Tab' },
      { to: '/home-service', label: 'Ana Sayfa Servisleri' },
      { to: '/cookie-text', label: 'Çerez Metinleri' },
      { to: '/address', label: 'Adresler' },
    ],
  },
  {
    to: '/slider',
